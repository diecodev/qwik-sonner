...
export default component$(() => {
  ...
  const position = useSignal<Required<Pick<ToasterProps, "position">>["position"]>("bottom-left");
    ...
    <div class="wrapper light">
      ...
      <main class="container">
        ...
        <p class="!mt-12 rounded-md bg-amber-100 p-2 !text-sm">
          ...
          component should be positioned at the beginning of where you want to use it. This way, you
          won't encounter{" "}
          <a
